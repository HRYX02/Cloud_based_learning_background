    ...
    <div class="app-container">
        ...
        <el-form label-width="120px">
            ...
            <el-form-item label="课程分类">
                <el-select v-model="courseInfo.subjectParentId" placeholder="课程类别" @change="subjectLevelOneChanged">
                ...
                <!-- 二级分类 -->
                <el-select v-model="courseInfo.subjectId" placeholder="课程名称">
    ...
    data() {
        return {
            courseInfo: {
                ...
                lessonNum: 0,
                description: '',
                cover: 'https://sxxstarbucket.oss-cn-beijing.aliyuncs.com/static/course.jpg',
                price: 0
            },
